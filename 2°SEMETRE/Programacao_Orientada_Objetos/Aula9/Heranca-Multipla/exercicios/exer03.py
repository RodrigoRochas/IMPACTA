...
class Moto(Automovel):
    ...
    def exibir_dados(self):
        ...
        print(f'Rodas : {self.rodas}')
        print(f'Potencia : {self.potencia}')
        print(f'PE : {self.partida_eletrica}')
...
bike.exibir_dados() # imprime os valores de todos os atributos da bicicleta
moto.exibir_dados() # imprime os valores de todos os atributos da moto
